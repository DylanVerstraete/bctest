...
import (
	...
	"github.com/DylanVerstraete/bctempla/pkg/config" // TODO: add repo
    ...
    var mintingPlugin    *minting.Plugin
      ...
      // register the minting extension plugin
			mintingPlugin = minting.NewMintingPlugin(
				...
				bctemplatypes.MinterDefinitionTxVersion,
				bctemplatypes.CoinCreationTxVersion,
        &minting.PluginOptions{
					CoinDestructionTransactionVersion: bctemplatypes.CoinDestructionTxVersion,
				},
			)
