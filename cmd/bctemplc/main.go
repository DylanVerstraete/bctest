...
import (
	...
	"github.com/DylanVerstraete/bctempla/pkg/config"
	"github.com/DylanVerstraete/bctempla/pkg/types"
...
func main() {
	...
	cliClient, err := NewCommandLineClient("http://localhost:23112", bchainInfo.Name, daemon.RivineUserAgent)
	if err != nil {
		panic(err)
	}
